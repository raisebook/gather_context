defmodule GatherContext.Types.V2.Fields.AttachmentSpec do
  use ESpec

  describe "encode" do
    alias GatherContext.Types.V2.Fields.Attachment

    let(uuid: "00000000-0000-0000-0000-000000000000")
    let(label: "Label")
    let(instructions: "<p>Instructions</p>")

    let(element: %Attachment{uuid: uuid(), label: label(), instructions: instructions()})

    subject(do: Attachment.encode(element()))
    ...
    describe "a default object" do
      let(element: %Attachment{label: label()})
